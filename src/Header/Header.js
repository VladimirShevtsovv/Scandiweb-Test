        ...
        return (
            <React.Fragment>
                {this.props.loadingInfo.fetchCategoriesAndCurrences.status !== null ?
                    <LoaderContainer statusOfLoad={this.props.loadingInfo.fetchCategoriesAndCurrences.status}
                                     errorMessage={this.props.loadingInfo.fetchCategoriesAndCurrences.errorMessage}/>
                    : <header className={styles.Header__container}>
                        <Category/>
                        <img src={Logo} alt={'Logo'}/>
                        <div><CurrencySwitcher createNewProductToCart={this.props.createNewProductToCart}
                                               selectPrice={this.props.selectPrice}
                                               createListWithAttribute={this.props.createListWithAttribute}/></div>
                    </header>
